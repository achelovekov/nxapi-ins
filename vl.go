					...
					"checkedProperties": {
					  "tahoe": {
						"vlanMembership_Sw_Hw": {
						  ...
						  "actualDetails": {
							"hwTableName": "tah_hom_luc_vifvlanmbrtable",
							"hwIndexName": "info_cbl_state_membership",
							"ifIndex": [
							  "436234240",
							  "436217344",
							  "436234752"
								...
								"units": [
								  {
									...
									"slices": [
									  {
										"number": 0,
										"bitmap": "0x00010000:0x00000000:0x00000000:0x00000000:0x00000000:0x00000000:0x00000000:0x10000004"
									  }
									]
								  }
								]
						...
						"epgStateTable_Sw_Hw": {
						  ...
						  "expectedDetails": {},
						  "actualDetails": {
							"hwTableName": "tah_hom_rwx_rwepgstatetable",
							"hwIndexName": "ifmbr",
							"tableData": [
							  {
								"number": 1,
								"units": [
								  {
									...
									"slices": [
									  {
										"number": 0,
										"bitmap": "0x00000001:0x10000000:0x00000080"
									  }
									]
								  }
								]
						...
						"floodMembership_Sw_Hw": {
						  ...
						  "expectedDetails": {},
						  "actualDetails": {
							"hwTableName": "tah_hom_qsmt_ovtbl",
							"hwIndexName": "data",
							"tableData": [
							  {
								"number": 1,
								"units": [
								  {
									...
									"slices": [
									  {
										"number": 0,
										"bitmap": "0x00000000:0x00000000:0x00000080"
									  }
									]
								  }
								]
...
func main() {
	...
	node6 := make([]Node, 3)
	node6_0 := Node{NodeName: "vlanMembership_Sw_Hw", ToDive: false, ToCombine: true}
	node6_1 := Node{NodeName: "epgStateTable_Sw_Hw", ToDive: false, ToCombine: true}
	node6_2 := Node{NodeName: "floodMembership_Sw_Hw", ToDive: false, ToCombine: false}
	node6[0] = node6_0
	node6[1] = node6_1
	node6[2] = node6_2

	/* 	node7 := make([]Node, 2)
	   	node7_0 := Node{NodeName: "expected", ToDive: false}
	   	node7_1 := Node{NodeName: "actual", ToDive: false}
	   	node7[0] = node7_0
	   	node7[1] = node7_1 */
